...
#define STATUS_DESCRIPTORS                                                                                             \
  {                                                                                                                    \
    "E_SUCCESS", "E_NOT_AVAILABLE", "E_NO_SENSOR", "E_NOT_INITIALIZED", "E_ALREADY_RUNNING",                           \
        ...
        "E_INSUFFICIENT_RESOURCES", "E_CHECKSUM_ERROR", "E_NO_PARAM_EXPECTED", "E_NOT_ENOUGH_PARAMS", "E_CMD_UNKNOWN", \
        "E_CMD_FORMAT_ERROR", "E_ACCESS_DENIED", "E_ALREADY_OPEN", "E_CMD_FAILED", "E_CMD_ABORTED",                    \
        "E_INVALID_HANDLE", "E_NOT_FOUND", "E_NOT_OPEN", "E_IO_ERROR", "E_INVALID_PARAMETER", "E_INDEX_OUT_OF_BOUNDS", \
        "E_CMD_PENDING", "E_OVERRUN", "E_RANGE_ERROR", "E_AXIS_BLOCKED", "E_FILE_EXISTS", NULL                         \
  }
...
// Devices
typedef enum { UNKNOWN = 0, DSACON32, WSG50, WSG32, KMS40 } device_t;
